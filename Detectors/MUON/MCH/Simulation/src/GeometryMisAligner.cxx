...
ClassImp(o2::mch::GeometryMisAligner);
...
GeometryMisAligner::GeometryMisAligner(double cartXMisAligM, double cartXMisAligW, double cartYMisAligM, double cartYMisAligW, double angMisAligM, double angMisAligW)
  : fUseUni(kFALSE),
    fUseGaus(kTRUE),
...
//______________________________________________________________________________
GeometryMisAligner::GeometryMisAligner(double cartMisAligM, double cartMisAligW, double angMisAligM, double angMisAligW)
  : fUseUni(kFALSE),
    fUseGaus(kTRUE),
    fXYAngMisAligFactor(0.0),
    fZCartMisAligFactor(0.0)
...
//______________________________________________________________________________
GeometryMisAligner::GeometryMisAligner(double cartMisAlig, double angMisAlig)
  : fUseUni(kTRUE),
    fUseGaus(kFALSE),
    fXYAngMisAligFactor(0.0),
    fZCartMisAligFactor(0.0)
...
void GeometryMisAligner::SetXYAngMisAligFactor(double factor)
{
...
//_________________________________________________________________________
void GeometryMisAligner::SetZCartMisAligFactor(double factor)
{
  /// Set XY angular misalign factor
  if (TMath::Abs(factor) < 1.0 && factor > 0.) {
...
//_________________________________________________________________________
TGeoCombiTrans GeometryMisAligner::MisAlignModule() const
{
  /// Misalign given transformation and return the misaligned transformation.
...
// void GeometryMisAligner::SetAlignmentResolution(const TClonesArray* misAlignArray, int rChId, double rChResX, double rChResY, double rDeResX, double rDeResY)
// {
