...
#ifndef O2_MCH_SIMULATION_GEOMETRY_MIS_ALIGNER
#define O2_MCH_SIMULATION_GEOMETRY_MIS_ALIGNER
...
{
 public:
  GeometryMisAligner(double cartXMisAligM, double cartXMisAligW, double cartYMisAligM, double cartYMisAligW, double angMisAligM, double angMisAligW);
  GeometryMisAligner(double cartMisAligM, double cartMisAligW, double angMisAligM, double angMisAligW);
  GeometryMisAligner(double cartMisAligW, double angMisAligW);
  GeometryMisAligner();
